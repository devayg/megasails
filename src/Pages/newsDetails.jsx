...
const NewsDetails = () => {
  return (
    <div>
      <Helmet>
        <title>Preparing Your Boat for Hurricane Season - MegaSails</title>
        <meta
          name="description"
          content="Secure your yacht this hurricane season with tips from Megasails. Learn how to protect your vessel and ensure safety with expert strategies"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Preparing Your Boat for Hurricane Season"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.megasails.com/news-details/preparing-for-hurricane"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://megasails.s3.us-east-2.amazonaws.com/Hurricane+Prep+for+Your+Yacht+-+Megasails.jpeg"
        />
