...
const NewsDetails1 = () => {
  return (
    <div>
      <Helmet>
        <title>
          HCB 39’ Speciale at 24th MBGFC Billfish Tournament - MegaSails{" "}
        </title>
        <meta
          name="description"
          content="Explore the remarkable 39’ yacht making waves! MegaSails showcases its stunning features and top performance. Discover this exceptional vessel now!"
        />
        <meta
          name="keywords"
          content="yacht hurricane preparation, yacht safety tips, hurricane season yacht, securing yacht hurricane, Megasails, yacht protection, hurricane-proofing yachts, yacht storm readiness, marine safety, hurricane preparedness, yacht storm protection, yacht disaster planning, hurricane impact on yachts, yacht safety measures, yacht resilience, storm-secure yachts, emergency yacht procedures, yacht weather safety, hurricane-resistant yachts, yacht care during storms"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="HCB 39’ Speciale at 24th MBGFC Billfish Tournament"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.megasails.com/news-details/39-turns-head"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://megasails.s3.us-east-2.amazonaws.com/HCB+39%E2%80%99+Speciale+at+24th+MBGFC+Billfish+Tournament+-+MegaSails.jpg"
        />
