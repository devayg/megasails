      ...
      <div className="container" style={{ textAlign: "justify" }}>
        ...
        <div>
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            Thank you for visiting MegaSails website. MegaSails appreciates your
            interest in our company and yachting services we offer. By visiting
            our website, you are accepting the Privacy Policy of use and Terms
            and Conditions in any other manner. Our Privacy Policy applies to
            all websites and online services of MegaSails.com. The Privacy
            Policy describes our use or disclosure of anonymous or personally
            identifiable information collected on or through our Website/
            Platform.
          </p>
          <h6 className="fw-bold bg-light p-2">
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            ...
            MegaSails site and associated platforms. We use this information to
            improve your experience and develop new experiences and products
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            ...
            subscribe in our Site/Platform you consent, MegaSails to use/share
            the data collected about you to provide, improve user experience of
            the products and services we offer as below To deliver and improve
            our Yacht broker and other yachting/boating related services To
            share yacht industry trends, new product releases, events,
            Promotions, and information we think will be of interest to you
            Receive emails for the products and services you have requested via
            MegaSails site/Platform/affiliated partner sites Analyze site usage,
            page visits, and other interests in connection to the Yacht/Boat
            products and Yachting/Boating Services offered on MegaSails
            Site/Platform Improve/present Site features/content with
            advertisements we think will be interest to you Share with our
            ...
            the portal forms on MegaSails Site/Platform Detect and prevent any
            malicious attacks on MegaSails and other affiliated sites/platform
          </p>
          <h6 className="fw-bold bg-light p-2">
            IBA – Interest Based Advertising / Online Behavioral Advertising
          </h6>
          <p style={{ textAlign: "justify" }} className="p-2">
            MegaSails Site/Platform participate in IBA - interest-based
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            MegaSails Site/Platform offers Yacht/OEM’s, Yacht/Boat Brokers, and
            other advertisers to promote their products and services as
            impressions in certain pages of MegaSails Website/Platform.
            MegaSails Platform does not allow to post content or items in an
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            MegaSails will retain and use the anonymous information gathered
            ...
            and statutory requirements. Occasionally MegaSails may oblige the
            Government agency request when asked. MegaSails will attempt to
            notify affected users to give them an opportunity to object, if not
            prohibited by law. MegaSails is a US based company, and you
            acknowledge that data you provide using our MegaSails
          ...
          <p style={{ textAlign: "justify" }} className="p-2">
            MegaSails Site/Platform takes reasonable measures to secure the
            ...
            solutions can be entirely secure. MegaSails cannot guarantee
            absolute security.
          </p>
          ...
          <h6 className="fw-bold bg-light p-2">AI Chat Assistance</h6>
          <p style={{ textAlign: "justify" }} className="p-2">
            The AI chat bot does not gather and store conversation data. The
            chat data is cleared when the chat session ends or when the
            browser is closed.
          </p>
          <h6 className="fw-bold bg-light p-2">To Contact Us</h6>
          <p style={{ textAlign: "justify" }} className="p-2">
            If you have any questions or concerns about our use of your personal
            information, please email: privacy@megasails.com
          </p>
          <h6 className="fw-bold bg-light p-2">
            Changes to this Privacy Policy - This Privacy Policy was revised 6th
            February.2023
